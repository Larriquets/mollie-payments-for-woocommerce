...
class Mollie_WC_Helper_SplitOrder {
    ...
    public static function getOrderRouting($order) {
		...
		$context = array( 'source' => 'Mollie_WC_Helper_SplitOrder' );
                ...
                if( !is_null($organizationId) ) { 
                    ...
                    if(  $gift_cards_totals == 0 ){
                            ...
                            $routes[] = [
                                "amount" => [                    
                                    "currency" => $currency,
                                    "value" => Mollie_WC_Plugin::getDataHelper()->formatCurrencyValue( $amount, $currency)
                                ],
                                "destination" => [
                                    "type" => "organization",
    ...
    public static function getPaymentMethodsFees() {
        ...
        $api = Mollie_WC_Plugin::getApiHelper()->getApiClient($test_mode);
